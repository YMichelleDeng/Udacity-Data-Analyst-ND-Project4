...
qplot(x = residual.sugar, data = wine, binwidth = 0.03) +
  scale_x_log10(breaks = seq(0,50,2))
...
qplot(x = chlorides, data = wine, binwidth = 0.02) +
  scale_x_log10(breaks = seq(0,0.2,0.01))
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# Paired plotting
wine_samp <- wine[sample(1:length(wine$quality), 50), ]
ggpairs(wine_samp)
```
...
ggplot(aes(total.sulfur.dioxide, residual.sugar), data = subset(wine, (residual.sugar <= quantile(wine$residual.sugar, 0.999) & total.sulfur.dioxide <= quantile(wine$total.sulfur.dioxide, 0.999)))) + 
  geom_point() +
...
ggplot(aes(total.sulfur.dioxide, free.sulfur.dioxide), data = subset(wine, (free.sulfur.dioxide <= quantile(wine$free.sulfur.dioxide, 0.999) & total.sulfur.dioxide <= quantile(wine$total.sulfur.dioxide, 0.999)))) + 
  geom_point() +
   geom_smooth(method='lm',color='red')
...
ggplot(aes(total.sulfur.dioxide, density), data = subset(wine, (density <= quantile(wine$density, 0.999) & total.sulfur.dioxide <= quantile(wine$total.sulfur.dioxide, 0.999)))) + 
  geom_point() +
   geom_smooth(method='lm',color='red')
...
ggplot(aes(total.sulfur.dioxide, alcohol), data = subset(wine, (alcohol <= quantile(wine$alcohol, 0.999) & total.sulfur.dioxide <= quantile(wine$total.sulfur.dioxide, 0.999)))) + 
  geom_point() +
   geom_smooth(method='lm',color='red')
...
ggplot(aes(residual.sugar, density), data = subset(wine, (residual.sugar <= quantile(wine$residual.sugar, 0.999) & density <= quantile(wine$density, 0.999)))) + 
  geom_point() +
   geom_smooth(method='lm',color='red')
...
ggplot(aes(residual.sugar, alcohol), data = subset(wine, (residual.sugar <= quantile(wine$residual.sugar, 0.999) & alcohol <= quantile(wine$alcohol, 0.999)))) + 
  geom_point() +
   geom_smooth(method='lm',color='red')
...
ggplot(aes(density, alcohol), data = subset(wine, (density <= quantile(wine$density, 0.999) & alcohol <= quantile(wine$alcohol, 0.999)))) + 
  geom_point() +
   geom_smooth(method='lm',color='red')
...
ggplot(aes(pH, fixed.acidity), data = subset(wine, (density <= quantile(wine$pH, 0.999) & alcohol <= quantile(wine$fixed.acidity, 0.999)))) +
  geom_point() +
  geom_smooth(method='lm',color='red')
...
ggplot(aes(density, alcohol), data = subset(wine, (density <= quantile(wine$density, 0.999) & alcohol <= quantile(wine$alcohol, 0.999)))) + 
  geom_point(aes(color = f.quality), na.rm =TRUE) +
...
ggplot(aes(density, residual.sugar), data = subset(wine, (density <= quantile(wine$density, 0.999) & residual.sugar <= quantile(wine$residual.sugar, 0.999)))) + 
  geom_point(aes(color = f.quality), na.rm =TRUE) +
  scale_color_brewer(type = "qual")
...
ggplot(aes(alcohol, residual.sugar), data = subset(wine, (alcohol <= quantile(wine$alcohol, 0.999) & residual.sugar <= quantile(wine$residual.sugar, 0.999)))) + 
  geom_point(aes(color = f.quality), na.rm =TRUE) +
  scale_color_brewer(type = "qual")
...
ggplot(aes(pH, fixed.acidity), data = subset(wine, (pH <= quantile(wine$pH, 0.999) & fixed.acidity <= quantile(wine$fixed.acidity, 0.999)))) + 
  geom_point(aes(color = f.quality), na.rm =TRUE) +
  scale_color_brewer(type = "qual")
```
...
m1 <- lm(quality ~ alcohol, data = subset(wine, alcohol <= quantile(wine$alcohol, 0.999)))
...
summary(lm(quality ~ alcohol + density + residual.sugar + volatile.acidity + fixed.acidity + sulphates + pH + free.sulfur.dioxide, data = subset(wine, alcohol <= quantile(wine$alcohol, 0.999))))
```
...
plot1 <- ggplot(aes(f.quality, alcohol), data = wine) +
  geom_boxplot(aes(fill = f.quality), show.legend = FALSE) +
...
# Density vs residual.sugar and quality
plot1 <- ggplot(aes(density, residual.sugar), data = subset(wine, (density <= quantile(wine$density, 0.999) & residual.sugar <= quantile(wine$residual.sugar, 0.999)))) + 
  geom_point(aes(color = f.quality), na.rm =TRUE) +
...
plot2 <- ggplot(aes(density, residual.sugar), data = subset(wine, (density <= quantile(wine$density, 0.999) & residual.sugar <= quantile(wine$residual.sugar, 0.999)))) + 
  geom_point(aes(color = f.quality), na.rm =TRUE, show.legend = FALSE) +
  scale_color_brewer(type = "qual") +
  facet_wrap(~f.quality) +
  xlab("Density (g / cm^3)") +
  ylab("Residual Sugar (g / dm^3)") +
